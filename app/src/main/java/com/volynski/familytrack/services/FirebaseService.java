...
/**
 * FirebaseService provides a listener service for app settings
        ...
        mDataSource.getUserByUuid(userUuid, new FamilyTrackDataSource.GetUserByUuidCallback() {
            ...
            public void onGetUserByUuidCompleted(FirebaseResult<User> result) {
                ...
                if (user != null) {
                    ...
                    SharedPrefsUtil.removeActiveGroup(FirebaseService.this);
                }
            }
        });
        return result;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (user != null) {
                    if (user.getActiveMembership() == null) {
                        SharedPrefsUtil.removeSettings(FirebaseService.this);
                        mActiveGroupUuid = "";
                    } else {
        ...
        if (!mActiveGroupUuid.equals("")) {
            ValueEventListener settingsListener = new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (settings != null) {
                        SharedPrefsUtil.setSettings(FirebaseService.this, settings);
                    } else {
